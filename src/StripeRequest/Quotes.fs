...
module Quotes =
    ...
    type Create'InvoiceSettings with
        static member New(?customFields: Choice<Create'InvoiceSettingsCustomFields list,string>, ?daysUntilDue: int, ?description: Choice<string,string>, ?footer: Choice<string,string>, ?issuer: Create'InvoiceSettingsIssuer) =
            {
    ...
    type Update'InvoiceSettings with
        static member New(?customFields: Choice<Update'InvoiceSettingsCustomFields list,string>, ?daysUntilDue: int, ?description: Choice<string,string>, ?footer: Choice<string,string>, ?issuer: Update'InvoiceSettingsIssuer) =
            {
                CustomFields = customFields
                DaysUntilDue = daysUntilDue
                Description = description
